...
<form name="frm_page" action="<c:url value='/customer/listByCategory.do' />" method="post">
	<input type="hidden" name="qnaTypeNo" value="${searchVO.qnaTypeNo }">
						...
						<div class="table-tr">
							<a href="<c:url value='/customer/countUpdate.do?no=${vo.qnaQuestionNo}'/>">
								<div class="table-td table-td-center col-sm-1 hidden-xs">
									<p>${pageVO.totalRecord- vo.rsnum+ 1 }</p>
								</div>
